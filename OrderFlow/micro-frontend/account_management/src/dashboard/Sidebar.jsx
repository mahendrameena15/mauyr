        ...
        <ul className="list-disc ">
          <li
            className={`ps-7 py-3 list-inside cursor-pointer  hover:bg-[#f2f2f2] dark:hover:bg-[#f2f2f2] hover:border-r-4 hover:border-[#147D73] ${
              location.pathname === "/main/account-management/dashboard"
                ? "active"
                : ""
            }`}
          >
            <div className="flex justify-start items-center gap-2">
              ...
              <Link
                to={`${originUrl}/main/account-management/dashboard`}
          ...
          <li
            className={`ps-7 py-3 list-inside cursor-pointer  hover:bg-[#f2f2f2] dark:hover:bg-[#f2f2f2] hover:border-r-4 hover:border-[#147D73] ${
              location.pathname === "/main/orders/all-orders" ? "active" : ""
            }`}
          >
            <Link
              to={`${originUrl}/main/orders/all-orders`}
              className="no-underline"
            >
              <div className="flex justify-start items-center gap-2">
                <div
                  className={`home ${
                    location.pathname === "/main/orders/all-orders"
                      ? "active"
                      : ""
                  }`}
                >
          ...
          <li
            className={`px-7 py-3  list-inside  cursor-pointer  hover:bg-[#f2f2f2] dark:hover:bg-[#f2f2f2] hover:border-r-4 hover:border-[#147D73] ${
              location.pathname === "/main/customers/all-customers" ||
              location.pathname ===
                "/main/customers/add-customer/customer-details"
                ? "active"
                : ""
            }`}
            onClick={() => {
          ...
          {openMenu && (
            <ul id="dropdown-example" className="  space-y-2 ">
              ...
              >
                <Link
                  to={`${originUrl}/main/customers/all-customers`}
              ...
              >
                <Link
                  to={`${originUrl}/main/customers/add-customer/customer-details`}
                  className="flex items-center w-full p-2 no-underline"
                >
          ...
          <li
            className={`px-7 py-3 list-inside cursor-pointer  hover:bg-[#f2f2f2] dark:hover:bg-[#f2f2f2] hover:border-r-4 hover:border-[#147D73] ${
              location.pathname === "/main/products/all-products" ||
              location.pathname === "/main/products/add-product"
                ? "active"
                : ""
            }`}
            onClick={() => {
          ...
          {isOpen && (
            <>
              <ul id="dropdown-example" className="  space-y-2 ">
                ...
                >
                  <Link
                    to={`${originUrl}/main/products/all-products`}
                    className="flex items-center w-full p-2 no-underline"
                  >
                ...
                >
                  <Link
                    to={`${originUrl}/main/products/add-product`}
                    className="flex items-center w-full p-2  no-underline"
                  >
                    <h6 className="text-base	font-medium  text-gray">
                      Add product
          ...
          <ul className="list-disc ">
            ...
            <li
              className={` px-6 py-3 list-inside cursor-pointer  hover:bg-[#f2f2f2] dark:hover:bg-[#f2f2f2] hover:border-r-4 hover:border-[#147D73] ${
                ...
                location.pathname ===
                  "/main/account-management/settings/bank-information" ||
                location.pathname === "/main/account-management/settings"
                  ? "active"
                  : ""
              }`}
            >
