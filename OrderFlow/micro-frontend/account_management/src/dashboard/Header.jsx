      ...
      >
                ...
                {isOpen && (
                  <div className=" z-50 w-60 absolute user-dropdown bg-white	shadow-md rounded-t-lg	h-44	">
                    <ul className="dropdown-content">
                      ...
                      >
                        <Link
                          to={`${originUrl}/main/account-management/profile`}
                        >
                      ...
                      >
                        <Link
                          to={`${originUrl}/main/account-management/settings`}
                        >
                      ...
                      <Link to={`${originUrl}/auth/sign-in`}>
                        <li
                          onClick={() => {
                            localStorage.clear();
                          }}
        ...
        <div className="block md:hidden w-full ">
          ...
          <div className=" relative">
            ...
            >
              <Link to={`${originUrl}/main/account-management/profile`}>
                <li className="py-2.5	px-4 cursor-pointer">
                  <h6 className="text-sm font-medium ">Profile</h6>
                </li>
              </Link>
              <Link to={`${originUrl}/main/account-management/settings`}>
                <li className="py-2.5	px-4 cursor-pointer">
                  <h6 className="text-sm font-medium">Settings</h6>
                </li>
              </Link>
